...
export const createRestaurant = `
  mutation CreateRestaurant($title: String!, $description: String!, $img: String, $direccion: String, $telefonos: String, $gps_coords: String) {
...
export const editRestaurant = `
  mutation EditRestaurant($_id: String, $title: String!, $description: String!, $img: String, $direccion: String, $telefonos: String, $gps_coords: String) {
    editRestaurant(category: {
      _id: $_id,
      title: $title,
      description: $description,
      img: $img,
